...
import org.TFAitcatramss.dao.MantenimientoFacade;
...
public class MantenimientoController implements Serializable {
    ...
    @EJB
    private org.TFAitcatramss.dao.MantenimientoFacade ejbFacade;
    ...
    public Mantenimiento getMantenimiento(java.lang.String id) {
